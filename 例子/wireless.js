...
return view.extend({
	...
	renderOverview: function() {
		...
		s.addModalOptions = function(s) {
			return network.getWifiNetwork(s.section).then(function(radioNet) {
				...
				if (hwtype == 'mac80211') {
					...
					o = ss.taboption('advanced', form.Flag, 'kickass', _('Use wireless culling'), _('Please go here to enable the wireless rejection monitoring script'));
					o.default = o.disabled;

					o = ss.taboption('advanced', form.Value, 'weak', _('Weak signal threshold'), _('Disconnect wireless terminals below this value (0 is disabled)'));
					o.depends('kickass', '1');
					o.datatype = 'range(-99, 0)';
					o.default = '0';

					o = ss.taboption('advanced', form.Value, 'high', _('Strong signal threshold'), _('Disconnect wireless terminals higher than this value (0 is disabled)'));
					o.depends('kickass', '1');
					o.datatype = 'range(-99, 0)';
					o.default = '0';
				}
		...
		s.handleAdd = function(radioDev, ev) {
			...
			uci.set('wireless', section_id, 'device', radioDev.getName());
			uci.set('wireless', section_id, 'mode', 'ap');
			uci.set('wireless', section_id, 'ssid', 'LEDE');
			uci.set('wireless', section_id, 'encryption', 'none');
