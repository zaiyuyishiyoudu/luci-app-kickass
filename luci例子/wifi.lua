...
if hwtype == "mac80211" then
  ...
  disassoc_low_ack.default = disassoc_low_ack.enabled
	...
	mp = s:taboption("advanced", ListValue, "weak", translate("Weak signal remove"))
	mp:value("", translate("disable"))
	for e=1,99 do
	mp:value(-e, translate("Signal:")..-e)
end

	mp = s:taboption("advanced", ListValue, "strong", translate("Strong signal remove"))
	mp:value("", translate("disable"))
	for c=1,80 do
	mp:value(-c, translate("Signal:")..-c)
end
end
